...
| <a name="input_sli_config"></a> [sli\_config](#input\_sli\_config) | n/a | <pre>object({<br/>    labels     = map(string)<br/>    nameserver = string<br/>    static_routes = list(object({<br/>      ip_address      = string<br/>      default_gateway = bool<br/>      interface = object({<br/>        name      = string<br/>        namespace = string<br/>        tenant    = string<br/>      })<br/>      attrs    = list(string)<br/>      prefixes = list(string)<br/>    }))<br/>  })</pre> | `null` | no |
| <a name="input_slo_config"></a> [slo\_config](#input\_slo\_config) | n/a | <pre>object({<br/>    labels     = map(string)<br/>    nameserver = string<br/>    static_routes = list(object({<br/>      ip_address      = string<br/>      default_gateway = bool<br/>      interface = object({<br/>        name      = string<br/>        namespace = string<br/>        tenant    = string<br/>      })<br/>      attrs    = list(string)<br/>      prefixes = list(string)<br/>    }))<br/>  })</pre> | `null` | no |
