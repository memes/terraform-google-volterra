...
run "provision" {
  ...
  assert {
    condition = try(volterra_securemesh_site_v2.site.local_vrf[0].sli_config[0].nameserver, "") == "10.0.0.1"
    error_message = "Expected site nameserver to be 10.0.0.1, got '${try(volterra_securemesh_site_v2.site.local_vrf[0].sli_config[0].nameserver, "")}'"
  }

  assert {
    condition = try(volterra_securemesh_site_v2.site.local_vrf[0].sli_config[0].nameserver_v6, "") == ""
    error_message = "Expected site nameserver_v6 to be empty, got '${try(volterra_securemesh_site_v2.site.local_vrf[0].sli_config[0].nameserver_v6, "")}'"
  }

  assert {
    condition = try(volterra_securemesh_site_v2.site.local_vrf[0].sli_config[0].vip, "") == "10.100.0.1"
    error_message = "Expected site vip to be 10.100.0.1, got '${try(volterra_securemesh_site_v2.site.local_vrf[0].sli_config[0].nameserver, "")}'"
  }

  assert {
    condition = try(volterra_securemesh_site_v2.site.local_vrf[0].sli_config[0].nameserver_v6, "") == ""
    error_message = "Expected site vip_v6 to be empty, got '${try(volterra_securemesh_site_v2.site.local_vrf[0].sli_config[0].vip_v6, "")}'"
  }
